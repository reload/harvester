 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="reloaddk\HarvesterBundle\Entity\ProjectRepository")
 * @ExclusionPolicy("all")
 */
class Project
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="reloaddk\HarvesterBundle\Entity\Entry", mappedBy="project")
     */
    protected $entries;

    /**
     * @ORM\ManyToOne(targetEntity="reloaddk\HarvesterBundle\Entity\Client", inversedBy="entries")
     ...
     * Set client
     *
     * @param \reloaddk\HarvesterBundle\Entity\Client $client
     * @return Project
     */
    public function setClient(\reloaddk\HarvesterBundle\Entity\Client $client = null)
    {
        $this->client = $client;
     ...
     * Get client
     *
     * @return \reloaddk\HarvesterBundle\Entity\Client
     */
