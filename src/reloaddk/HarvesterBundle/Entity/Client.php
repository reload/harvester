 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="reloaddk\HarvesterBundle\Entity\ClientRepository")
 * @ExclusionPolicy("all")
 */
class Client
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="reloaddk\HarvesterBundle\Entity\Project", mappedBy="client")
     */
    protected $projects;
     ...
     * Add projects
     *
     * @param \reloaddk\HarvesterBundle\Entity\Project $projects
     * @return Client
     */
    public function addProject(\reloaddk\HarvesterBundle\Entity\Project $projects)
    {
     ...
     * @param \reloaddk\HarvesterBundle\Entity\Project $projects
     */
    public function removeProject(\reloaddk\HarvesterBundle\Entity\Project $projects)
    {
